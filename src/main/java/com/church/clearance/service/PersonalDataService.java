...
public class PersonalDataService {
	...
	public ResultReturn getPeronalData(String eid){
		...
		if(personal == null ||personal.getClearances()== null ||personal.getClearances().get(personal.getClearances().size()-1).getStatus().equalsIgnoreCase("Draft") ){
		...
		else if(personal.getClearances() !=null &&personal.getClearances().get(personal.getClearances().size()-1).getStatus().equalsIgnoreCase("Active") ){
		...
		else if(personal.getClearances() !=null &&personal.getClearances().get(personal.getClearances().size()-1).getStatus().equalsIgnoreCase("Cancel") ){
